...
def parse_args():
    ...
    p.add_argument("--mix_steps", type=int, default=4,
                   help="Blend state tokens for the first N Euler steps (Option A: "
                        "advance the mixed trajectory). 0 disables.")
    p.add_argument("--mix_weights", nargs=3, type=float, default=[0.33, 0.34, 0.33],
